...
<div class="container">
    ...
    <div class="col-12  m-auto mt-5">
        ...
        <a href="<?= site_url('/productlist')?>" class="btn btn-success m-1 mb-1">Product List</a></div>
                   ...
                   $i=1;
                    ...
                    {  ?>
                     <tr> 
                        ...
                        <td><a href="<?= site_url('vendor/remove/' . $row['orders_id']); ?>" class="btn btn-light" onclick="return confirm('Are you sure')">Remove</a></td>
